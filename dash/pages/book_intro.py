    ...
    for category, metadata in category_metadata.items():
        ...
        if category_pages:  # Only create card if there are pages in this category
            ...
            ordered_pages = sorted(
                category_pages,
                key=lambda x: metadata['views'].index(x["name"]) if x["name"] in metadata['views'] else len(metadata['views'])
            )
            ...
            cards.append(
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                DashIconify(icon=metadata['icon'], className="me-2"),
                                category
                            ], className="h5 mb-3"),
                            html.Ul([
                                html.Li(
...
def layout():
    return dbc.Container([
        ...
        html.Div([
            ...
            html.H2("Welcome to the Databricks Apps Cookbook!", 
                   className="mb-3 mt-4"),  # Added top margin
            
            html.P("Are you ready to serve some tasty apps to your users? You're in the right place!", 
                  className="lead mb-4"),  # Increased bottom margin
            ...
            html.P([
                ...
                html.A("GitHub repository", href="https://github.com/databricks/databricks-apps", target="_blank"),
                "!"
            ], className="mb-3"),  # Increased bottom margin before recipes
        ], className="py-3"),  # Added vertical padding to the header section
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Ul([
                    ...
                    html.Li(html.A("Azure", href="https://learn.microsoft.com/azure/databricks/dev-tools/databricks-apps/", target="_blank")),
            ...
            dbc.Col([
                ...
                html.Ul([
                    html.Li(html.A("Databricks Apps Templates", href="https://github.com/databricks/databricks-apps", target="_blank"))
                ], className="list-unstyled")
            ], md=4),
            dbc.Col([
                html.H4("Blog posts", className="h5 mb-3"),
                html.Ul([
                    html.Li(html.A("Building Data Applications", href="https://www.databricks.com/blog/building-data-applications", target="_blank"))
                ], className="list-unstyled")
            ], md=4)
        ])
