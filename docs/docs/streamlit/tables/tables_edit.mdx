...
Use this recipe to **read, edit, and write back data ina Unity Catalog table** using the [Databricks SQL Connector](https://docs.databricks.com/en/dev-tools/python-sql-connector.html).
